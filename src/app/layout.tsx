...
export const metadata: Metadata = {
  title: "AquaGuard AI — Smart Water Tank Management & Pump Controller",
  description: "AI-Powered Water Tank Management, Automatic Pump Controller & Leakage Detection",
};
